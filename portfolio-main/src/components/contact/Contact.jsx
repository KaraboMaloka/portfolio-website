...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
    .sendForm("service_trfb9z9", "template_yta659f", formRef.current, "yhs45V_8b8FNBoeWP")
    .then(
      (result) => {
        console.log(result);
        setSuccess(true);
    ...
    >
      <motion.div className="textContainer" variants={variants}>
        ...
        <motion.div className="item" variants={variants}>
          <h2>E-mail:</h2>
          <span>karabomaloka92@gmail.com</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Address:</h2>
...
{error && <p className="errorMsg">Oops! Something went wrong. Please try again.</p>}
{success && <p className="successMsg">✅ Message sent successfully!</p>}
